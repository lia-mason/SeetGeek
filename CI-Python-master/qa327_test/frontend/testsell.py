...
class SellFormTest(BaseCase):
    ...
    #This function checks whether profile page displays the newly added ticket information
    @patch('qa327.backend.get_user', return_value=test_user)
    def test_tickets_displayed(self, *_):
        self.open(base_url + '/logout')
        #open login page
        self.open(base_url + '/login')
        #fill email and password
        ...
        self.assert_text("Title: Superman, Price: 18, Quantity: 20, Expiration Date: 20210319")